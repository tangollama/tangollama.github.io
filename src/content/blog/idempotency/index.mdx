...
author: "Joel Worrall"
pubDate: "2021-01-15"
heroImage: '/images/blog/idempotency.png'
---

import ImageGalleryIsland from "../../../components/ImageGalleryIsland.astro";

_With appreciation for an imperfect [2020 soundtrack](https://www.youtube.com/watch?v=ZRjaUjJb3Z8) fit for a stripped-down word of thanks, and Seth's timely [post](https://seths.blog/2021/01/the-difficult-choice-of-disappointment/)._

First, rather than bury the lead. I'll get to the news.

This month, I'm completing my time as the head of open source at [New Relic](http://opensource.newrelic.com) and taking a leadership role in the Platform organization at [Stripe](https://stripe.com). If you're surprised by that news, I assure you that you're not as surprised as [January 2020 Joel](https://www.youtube.com/watch?v=Ms7capx4Cb8) would have been to read it. Thus, the start of 2021 marks a season of change.

And as I'm navigating a new transition, I've been thinking about a concept: _idempotency_.

If you're not familiar with **idempotency**, it describes the ability to execute something multiple times without impacting the intended result. Something that is idempotent produces a consistent and reliable outcome. In math, **multiplying by 0** is an idempotent operation. In everyday life, elevator call buttons or crosswalks are idempotent. Once you push the button or call the operation, the procedure is going to execute (_pushing the button multiple times doesn't make it go faster_), and it's going to deliver the same thing.

![Crosswalk](/images/blog/crosswalk.jpg)

The work I've been engaged in most recently at New Relic has brought this concept into focus, as my team has been creating a new piece of platform architecture for [New Relic One](https://one.newrelic.com) involving the open source [command line interface](https://github.com/newrelic/newrelic-cli) and a [contributor-centric](/talks/ato-2020/) [library of tasks](https://github.com/newrelic/open-install-library/tree/main/docs) that are executed by the CLI. Consequently, there's been a lot of team conversation about performing _something_ numerous times and seeing a reliable result.
...
I can point to some key ingredients like a culture of mentored leadership, trust and autonomy, an emphasis on influence vs. authority, and shared vision; but what I keep coming back to is simply _gratitude_ for so many co-workers who've made those consistent and reliable outcomes possible. I've partnered with so many remarkable people, and their character and grit has been the _biggest_ factor in the reliable success we've enjoyed.

<ImageGalleryIsland />

I try to live my life within a worldview that recognizes everything good that comes to me as a gift from a [generous host](https://bibleproject.com/explore/video/generosity/), and that certainly includes relationships. Good co-workers are a blessing, and I've received the benison of partnering with many admirable humans.

And it's those people, those gifts, which have occupied my thoughts of late and in particular how _idempotent_ I've found them to be, operating consistently and reliably. I'm so grateful for the many generous colleagues and friends at New Relic who've been a part of this chapter of my journey.

To each of you: **thank you** for letting me be a part of the team.

## So what's next?

![Stripe logo](/images/blog/stripe.png)

After almost 3 years at [New Relic](http://opensource.newrelic.com), I'm headed towards a new adventure with a new team and new challenges. I'm joining the Platform leadership team at [Stripe](https://stripe.com), taking on some cross-organizational initiatives, and once again defining a job that was created to fit my unique (_hopefully useful_) skills with a remit of authority that will become evident in the year ahead. It's a journey I've gotten used to navigating, and I'm excited and grateful to be invited to do it again in service to another remarkable [organization](https://stripe.com/docs) and [mission](https://stripe.com/about#:~:text=Our%20mission%20is%20to%20increase,and%20manage%20their%20businesses%20online.).
